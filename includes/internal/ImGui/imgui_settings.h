...
inline float menu[4] = { 0/255.f, 191/255.f, 255/255.f, 1.000f };

namespace c
{
	inline ImVec4 accent_color = ImColor(menu[0],menu[1],menu[2]);//ImColor(250, 132, 86);
	inline ImVec4 accent_low_color = ImColor(250, 132, 86,255/2);
	inline ImVec4 accent_low = ImColor(174, 197, 255, 255 / 2);

	inline ImVec4 accent_text_color = ImColor(255, 255, 255);

	inline ImVec4 accent_text_low_color = ImColor(255, 255, 255, 255 / 2);
