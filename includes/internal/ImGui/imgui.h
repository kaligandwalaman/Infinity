...
namespace ImGui
{
    ...
    IMGUI_API bool          SUBTAB(const char* name, bool boolean);
    IMGUI_API bool          TAB(const char* icon, const char* name, bool boolean);
    IMGUI_API bool          ButtonExes1(const char* icon, const char* name, bool boolean);
    //IMGUI_API bool          TAB_PC(const char* icon, const char* name, const ImVec2& size_arg, bool boolean);
    IMGUI_API bool          ButtonExes3(const char* name, bool boolean);
    IMGUI_API bool          ButtonExes4(const char* name, bool boolean);
    IMGUI_API bool          ButtonExes5(const char* name, bool boolean);
    IMGUI_API bool          OptButton(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    IMGUI_API bool          IMGUI_GOD_CLOSE(const char* ico, const char* name, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    IMGUI_API bool          OptButton1(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    IMGUI_API bool          OptButton2(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    IMGUI_API bool          OptButton3(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
    IMGUI_API bool          OptButton4(const char* ico, const ImVec2& size = ImVec2(0, 0), bool rotation = false);   // button
