...
//#endif
    ...
    IMGUI_API bool          OptButtonEx0(const char* ico, const char* name, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          OptButtonEx1(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          OptButtonEx2(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          OptButtonEx3(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          OptButtonEx4(const char* ico, const ImVec2& size_arg = ImVec2(0, 0), bool rotation = false, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos);   
