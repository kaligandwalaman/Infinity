...
#include "fonts/menu/New.h"
#include "fonts/menu/F50.h"
...
bool ImGui_init() {
    ...
    F48 = io.Fonts->AddFontFromMemoryTTF((void*)New1_data, New1_size, 25.0f, nullptr, io.Fonts->GetGlyphRangesDefault());
    F50 = io.Fonts->AddFontFromMemoryTTF((void*)F50_data,  F50_size,  30.0f, nullptr, io.Fonts->GetGlyphRangesDefault());
    JAAT = F48;
