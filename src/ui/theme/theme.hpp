...
namespace clr {
    ...
    inline ImVec4 accent       = ImVec4(0/255.f,   191/255.f, 255/255.f, 1.f);
    inline ImVec4 accent_light = ImVec4(80/255.f,  210/255.f, 255/255.f, 1.f);
    inline ImVec4 accent_dark  = ImVec4(0/255.f,   150/255.f, 200/255.f, 1.f);
